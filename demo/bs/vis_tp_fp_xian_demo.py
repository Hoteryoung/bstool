...
if __name__ == '__main__':
    pred_csv_file = '/home/jwwangchn/Documents/100-Work/170-Codes/aidet/results/buildchange/bc_v015_mask_rcnn_r50_v2_roof_trainval/bc_v015_mask_rcnn_r50_v2_roof_trainval_footprint_merged_0.3.csv'
    gt_csv_file = '/data/buildchange/v0/xian_fine/xian_val_footprint_gt_minarea100.csv'
