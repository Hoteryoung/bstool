...
if __name__ == '__main__':
    roof_csv_file = './data/urban3d/v0/val/urban3d_2048_roof_gt.csv'
    footprint_csv_file = './data/urban3d/v0/val/urban3d_2048_footprint_gt.csv'
    ...
    json_dir = f'./data/urban3d/v1/val/{generation_mode}'
