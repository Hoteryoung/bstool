...
if __name__ == '__main__':
    src_json_file = './data/urban3d/v2/coco/annotations/urban3d_v2_train_JAX_OMA.json'
    # src_json_file = '/data/buildchange/v1/coco/annotations/buildchange_v1_train_samples.json'
    dst_json_file = './data/urban3d/v2/coco/annotations/urban3d_v2_train_JAX_OMA_compression.json'
