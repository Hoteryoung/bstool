...
if __name__ == '__main__':
    ...
    pkl_file = '/data/buildchange/results/bc_v100.01.04_offset_rcnn_r50_2x_public_20201028_lr_0.02/bc_v100.01.04_offset_rcnn_r50_2x_public_20201028_lr_0.02_xian_public_coco_results.pkl'
    ann_file = '/data/buildchange/public/20201028/coco/annotations/buildchange_public_20201028_val_xian_fine.json'
